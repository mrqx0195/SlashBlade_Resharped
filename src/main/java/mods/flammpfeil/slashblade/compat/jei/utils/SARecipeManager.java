...
public class SARecipeManager implements ISimpleRecipeManagerPlugin<SlashArts> {
    ...
    @Override
    public @NotNull List<SlashArts> getRecipesForInput(ITypedIngredient<?> iTypedIngredient) {
    ...
    @Override
    public @NotNull List<SlashArts> getRecipesForOutput(@NotNull ITypedIngredient<?> iTypedIngredient) {
        return List.of();
    }
    
    @Override
    public @NotNull List<SlashArts> getAllRecipes() {
