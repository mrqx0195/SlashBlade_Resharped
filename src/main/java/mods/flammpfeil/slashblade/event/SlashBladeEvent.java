...
public abstract class SlashBladeEvent extends Event {
    ...
    public static class PerformSlashArtEvent extends Event implements ICancellableEvent {
        ...
        public PerformSlashArtEvent(LivingEntity entityLiving, int elapsed, ISlashBladeState state, @Nullable ResourceLocation comboState, @Nullable SlashArts.ArtsType type) {
        ...
        public void setComboState(@Nullable ResourceLocation comboState) {
            this.comboState = comboState;
        }
